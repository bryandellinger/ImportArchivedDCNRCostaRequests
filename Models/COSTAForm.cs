...
namespace ImportArchivedDCNRCostaRequests
{
    ...
    public class COSTAForm 
    {
        ...
        public int? ParentOSTFormId { get; set; }
        ...
        public string TravelerGroupAttendees { get; set; }
        public bool? IsGuestInd { get; set; }
        public int? DepartmentTypeId { get; set; }
        public string EmployeeWorkPhoneExtension { get; set; }
        public string DeclinedSubsitenceReimbursementDescription { get; set; }
        public string DeclinedLodgingReimbursementDescription { get; set; }
        public bool? IsLodgingReimbursement { get; set; }
        public string GiftBanAnalysis { get; set; }
    }
}